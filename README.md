...
```sh
git clone git@github.com:Ismael-G/Floating-Point-Multiplication.git
cd Floating-Point-Multiplication
```
...
#### Commit your changes
```sh
git commit -m 'Starting Floating-Point-Multiplication'
